    ...
    return (
        <div className="navbar bg-base-100 shadow-xl">
            <div className="navbar-start">
                ...
                <ul tabIndex={0} className="menu menu-sm dropdown-content </div>mt-3 z-[1] p-2 shadow bg-neutral rounded-box w-52">
                    { 
                        status ? (userDetected) : (<NavBarItems id="mobileModal"/>)
                    }
                </ul>
                </div>
            <a className="btn btn-ghost text-xl" href="/">Budget Tracker</a>
            </div>
